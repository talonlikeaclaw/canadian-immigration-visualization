...
function displayMontreal(ref){
  return (
    <>
      ...
      <section className="montreal-section city-section" ref={ref}>
        <p>
...
function displayToronto(ref){
  return (
    <>
      ...
      <section className="toronto-section city-section" ref={ref}>
        <p>
...
function displayCalgary(ref){
  return (
    <>
      ...
      <section className="calgary-section city-section" ref={ref}>
        <p>
...
function displayVancouver(ref){
  return (
    <>
      ...
      <section className="vancouver-section city-section" ref={ref}>
        <p>
